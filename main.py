...
# find_all():
# The find_all() method will return the list of all <div> HTML elements identified
# by the quote class. In other terms, this line of code is equivalent to applying the .quote CSS selector to retrieve
# the list of quote HTML elements on the page.
#
# find():
# Thanks to the Beautiful Soup find() method you can extract the single HTML element of interest.
# Since the tags associated with the quote are more than one, you should store them in a list.
